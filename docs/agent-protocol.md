...
| --- | --- | --- | --- |
| Incremental inventory reopening and conditional checkpoints | Codex | in progress | `codex/deep-debug`, base `1a03e63`, inspected main `7a4dd93`; 2026-09-20 UTC; offline inventory/replay tests and fixes |
